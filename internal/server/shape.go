...
// the complement of parked, held and terminal, spelled out here rather than
// imported: internal/engine keeps those predicates unexported, and this file
// must not become a reason to export them.
func isRunning(state string) bool {
	switch state {
	case "AWAITING_SPEC_APPROVAL", "AWAITING_CODE_APPROVAL",
